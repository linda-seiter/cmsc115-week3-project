...
class PaintCalculatorTest {
	...
	//Task #1
	@Test
	void givenFeetInches_whenConvertToFeet_thenReturnFeet() {
		double delta = 0.001;
	...
	//Task #2
	@Test
	void givenLengthWidth_whenCalculateCeilingArea_thenReturnArea() {
	...
	//Task #3
	@Test
	void givenLengthWidthHeight_whenCalculateWallArea_thenReturnArea() {
	...
	//Task #4
	@Test
	void givenLengthWidthHeight_whenRoomArea_thenReturnArea() {
	...
	//Task #5
	@Test
	void givenLengthWidthHeight_whenCalculatePaintGallons_thenReturnGallons() {
	...
	//Task #6
	@Test
	void givenRoomDimensionsGallonPrice_whenCalculatePaintCost_thenReturnCost() {
	...
	//Disabling tests for a task that is not yet complete
	@Disabled("Task not completed yet")
	@Test
	void testTaskNotYetCompleted() {
		assertEquals("The answer to the universe", "?");
	}
